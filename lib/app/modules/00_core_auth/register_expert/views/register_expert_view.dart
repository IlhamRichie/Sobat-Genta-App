...
import '../controllers/register_expert_controller.dart'; // <-- UBAH IMPORT
...
class RegisterExpertView extends GetView<RegisterExpertController> { // <-- UBAH CONTROLLER
  ...
  Widget _buildHeader() {
    return const Column(
      ...
      children: [
        ...
        SizedBox(height: 8),
        Text(
          'Bagikan keahlian Anda kepada para petani.', // <-- UBAH TULISAN
          style: TextStyle(
            fontSize: 17,
  ...
  Widget _buildRegisterButton(BuildContext context) {
    return ElevatedButton(
      onPressed: () => controller.registerExpert(context), // <-- UBAH AKSI
      ...
      child: const Text(
        'Daftar sebagai Pakar', // <-- UBAH TULISAN
